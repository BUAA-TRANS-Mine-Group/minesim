...
- **Simulation Engine:** The *Simulation Engine* serves as the core of MineSim. It includes multiple components: *Environment Manager*，*Prediction Algorithm*, *Planning Algorithm*, *Motion Controller*, *Ego Update Model*, *Agent Update Policy*,  and *Test Logger*.
